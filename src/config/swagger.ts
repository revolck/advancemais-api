      ...
      schemas: {
        ...
        Curso: {
          ...
          properties: {
            ...
            valor: {
              ...
              format: 'decimal',
              example: 299.9,
              description: 'Valor do curso em reais (R$). Se o curso for gratuito, será 0.',
            },
            valorPromocional: {
              type: 'number',
              format: 'decimal',
              ...
              example: 249.9,
              description:
                'Valor promocional do curso em reais (R$). Se não houver promoção, será null.',
            },
            gratuito: {
              type: 'boolean',
              example: false,
              description: 'Indica se o curso é gratuito. Se true, o valor será 0.',
            },
            criadoEm: { type: 'string', format: 'date-time', example: '2024-01-01T12:00:00Z' },
        ...
        UserRegisterPessoaFisicaRequest: {
          ...
          properties: {
            ...
            authId: {
              type: 'string',
              description: 'Identificador de autenticação do usuário',
              example: 'uuid-auth',
            },
            tipoUsuario: {
              type: 'string',
        ...
        UserProfile: {
          ...
          properties: {
            ...
            authId: { type: 'string', example: 'uuid-auth' },
          ...
          properties: {
            ...
            endpoints: {
              ...
              properties: {
                ...
                popups: { type: 'string', example: '/popups' },
              },
            },
            status: { type: 'string', example: 'operational' },
          },
        ...
        WebsitePopupDispositivo: {
          type: 'string',
          enum: ['AMBOS', 'MOBILE', 'DESKTOP'],
          example: 'AMBOS',
        },
        WebsitePopupEscopo: {
          type: 'string',
          enum: ['WEBSITE', 'DASHBOARD', 'AMBOS'],
          example: 'WEBSITE',
        },
        WebsitePopupPosicao: {
          type: 'string',
        ...
        WebsitePopupGatilho: {
          type: 'string',
          enum: ['IMEDIATAMENTE', 'ATRASO', 'INATIVIDADE', 'SCROLL', 'SAIDA', 'CLIQUE', 'HOVER'],
          example: 'ATRASO',
        },
        WebsitePopupCronograma: {
          type: 'string',
          enum: ['EXIBIR_AGORA', 'PERIODO'],
          example: 'EXIBIR_AGORA',
        },
        WebsitePopupFrequencia: {
          type: 'string',
          enum: [
            'SEM_LIMITE',
            'UMA_VEZ_POR_SESSAO',
          ...
          example: 'UMA_VEZ_A_CADA_6_HORAS',
        },
        WebsitePopup: {
          type: 'object',
          properties: {
            id: { type: 'string', format: 'uuid' },
            nome: { type: 'string', example: 'Newsletter - Junho' },
            templateSlug: { type: 'string', nullable: true, example: 'newsletter-neon' },
            status: { $ref: '#/components/schemas/WebsiteStatus' },
            dispositivo: { $ref: '#/components/schemas/WebsitePopupDispositivo' },
            escopo: { $ref: '#/components/schemas/WebsitePopupEscopo' },
            posicaoDesktop: { $ref: '#/components/schemas/WebsitePopupPosicao' },
            posicaoMobile: { $ref: '#/components/schemas/WebsitePopupPosicao' },
            gatilho: { $ref: '#/components/schemas/WebsitePopupGatilho' },
            triggerTarget: {
              type: 'string',
              nullable: true,
              example: 'website-nav-courses',
            },
            cronograma: { $ref: '#/components/schemas/WebsitePopupCronograma' },
            frequencia: { $ref: '#/components/schemas/WebsitePopupFrequencia' },
            contentConfig: { type: 'object' },
            formFields: { type: 'array', items: { type: 'object' } },
            designConfig: { type: 'object' },
            pageRules: { type: 'object', nullable: true },
            criadoEm: { type: 'string', format: 'date-time' },
            atualizadoEm: { type: 'string', format: 'date-time' },
          },
        },
        WebsitePopupInput: {
          ...
          required: ['nome'],
          properties: {
            nome: { type: 'string', maxLength: 100, example: 'Newsletter - Junho' },
            templateSlug: { type: 'string', nullable: true, example: 'newsletter-neon' },
            status: { $ref: '#/components/schemas/WebsiteStatus' },
            dispositivo: { $ref: '#/components/schemas/WebsitePopupDispositivo' },
            escopo: { $ref: '#/components/schemas/WebsitePopupEscopo' },
            ...
            atrasoSegundos: { type: 'integer', example: 5 },
            cronograma: { $ref: '#/components/schemas/WebsitePopupCronograma' },
            frequencia: { $ref: '#/components/schemas/WebsitePopupFrequencia' },
            tag: { type: 'string', nullable: true, example: 'From PopUp' },
            redirectUrl: {
              type: 'string',
              format: 'uri',
              nullable: true,
            ...
            redirectNovaAba: { type: 'boolean', example: false },
            contentConfig: { type: 'object' },
            formFields: { type: 'array', items: { type: 'object' } },
            designConfig: { type: 'object' },
            subscriptionConfig: { type: 'object', nullable: true },
            pageRules: { type: 'object', nullable: true },
          },
        },
        WebsitePopupContato: {
          ...
          properties: {
            id: { type: 'string', format: 'uuid' },
            popupId: { type: 'string', format: 'uuid' },
            nome: { type: 'string', nullable: true },
            ...
            payload: { type: 'object' },
            origemPath: { type: 'string', nullable: true },
            criadoEm: { type: 'string', format: 'date-time' },
          },
        },
        ...
        WebsiteInformacoes: {
          ...
          properties: {
            ...
            trabalheConoscoUrl: {
              type: 'string',
              nullable: true,
              example: 'https://empresa.com/carreiras',
            },
            email: {
              type: 'string',
              nullable: true,
        ...
        AdminEmpresaCreateInput: {
          type: 'object',
          required: ['nome', 'email', 'telefone', 'senha', 'authId', 'cnpj'],
          properties: {
            nome: {
              type: 'string',
        ...
        AdminEmpresaDetail: {
          ...
          properties: {
            ...
            historicoFinanceiro: {
              type: 'array',
              description:
                'Últimas até 4 contratações de planos anteriores com dados financeiros e período de vigência.',
        ...
        AdminEmpresaOverviewEmpresa: {
          ...
          properties: {
            ...
            bloqueada: {
              type: 'boolean',
              example: false,
              description: 'Indica se há um bloqueio ativo aplicado à empresa.',
            },
            bloqueioAtivo: {
              allOf: [{ $ref: '#/components/schemas/AdminUsuariosEmBloqueiosResumo' }],
              nullable: true,
        ...
        AdminVagaCandidato: {
          ...
          description:
            'Lista de candidatos vinculados às candidaturas da vaga, incluindo dados completos do usuário e todas as candidaturas enviadas.',
        },
        AdminVagaProcesso: {
          type: 'object',
          required: ['id', 'vagaId', 'candidatoId', 'status', 'origem', 'criadoEm', 'atualizadoEm'],
          ...
          allOf: [
            { $ref: '#/components/schemas/AdminEmpresaVagaResumo' },
            {
              ...
              properties: {
                ...
                candidatos: {
                  type: 'array',
                  items: { $ref: '#/components/schemas/AdminVagaCandidato' },
                  description:
                    'Candidatos derivados das candidaturas da vaga, agrupando múltiplas inscrições por candidato quando houver.',
                },
                processos: {
                  type: 'array',
        ...
        AdminCandidatoCandidatura: {
          ...
          properties: {
            ...
            statusProcessosCandidatos: {
              allOf: [{ $ref: '#/components/schemas/StatusProcesso' }],
              description: 'Objeto completo do status do processo seletivo',
            },
            origem: { allOf: [{ $ref: '#/components/schemas/OrigemVagas' }] },
            aplicadaEm: { type: 'string', format: 'date-time', example: '2024-05-11T10:00:00Z' },
            atualizadaEm: { type: 'string', format: 'date-time', example: '2024-05-11T10:00:00Z' },
            ...
            vaga: {
              ...
              description: 'Dados completos da vaga associada à candidatura. Sempre presente.',
            },
            empresa: {
              allOf: [{ $ref: '#/components/schemas/AdminVagaUsuarioResumo' }],
              nullable: true,
