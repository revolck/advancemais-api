  ...
  try {
    ...
    const questoes = [
      { tipo: 'TEXTO', ordem: 1, peso: 3.0, enunciado: 'Explique o conceito de herança em POO.' },
      {
        ...
        ordem: 2,
        peso: 1.5,
        enunciado: 'Qual linguagem é mais usada no front-end?',
        alternativas: 2,
      },
      {
        tipo: 'MULTIPLA_ESCOLHA',
        ordem: 3,
        peso: 2.0,
        enunciado: 'Qual método HTTP cria recursos?',
        alternativas: 3,
      },
      {
        tipo: 'MULTIPLA_ESCOLHA',
      ...
      },
      {
        ...
        ordem: 5,
        peso: 2.5,
        enunciado: 'Qual framework JS é mais popular?',
        alternativas: 5,
      },
      ...
      if (questao.tipo === 'TEXTO') {
        ...
        `,
          [
            ...
            inscricao.id,
            envioId,
            'Resposta de teste para questão de texto.',
            false,
          ],
        );
