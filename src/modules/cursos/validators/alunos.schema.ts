...
import {
  entrevistaModalidadeValues,
  entrevistaStatusValues,
...
export const alunoEntrevistasQuerySchema = z
  .object({
    ...
    sortBy: z
      .enum(['agendadaPara', 'criadoEm', 'statusEntrevista', 'vagaTitulo', 'empresaNome'])
...
export const alunoCriarEntrevistaSchema = z
  .object({
...
export type AlunoEntrevistasQuery = z.infer<typeof alunoEntrevistasQuerySchema>;
export type AlunoCriarEntrevistaInput = z.infer<typeof alunoCriarEntrevistaSchema>;
